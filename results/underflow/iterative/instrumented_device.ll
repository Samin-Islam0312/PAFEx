...
define dso_local ptx_kernel void @_Z22testIterativeUnderflowPfPi(ptr noundef %results, ptr noundef %underflow_step) #2 !dbg !971 {
entry:
...
; Function Attrs: convergent mustprogress noinline norecurse nounwind optnone
define dso_local ptx_kernel void @_Z23testUnderflow_SummationPf(ptr noundef %result) #2 !dbg !1060 {
entry:
