...
source_filename = "tests/basic_tests/overflow/round_negative.cu"
...
if.then:                                          ; preds = %entry
  ...
  %6 = call float @llvm.nvvm.add.rm.f(float %4, float %5), !dbg !990
...
if.then3:                                         ; preds = %if.end
  ...
  %12 = call float @llvm.nvvm.mul.rm.f(float %10, float %11), !dbg !1007
...
if.then8:                                         ; preds = %if.end6
  ...
  %18 = call float @llvm.nvvm.mul.rm.f(float %16, float %17), !dbg !1022
...
if.then13:                                        ; preds = %if.end11
  ...
  %25 = call float @llvm.nvvm.add.rm.f(float %23, float %24), !dbg !1039
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.add.rm.ftz.f(float, float) #1

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.add.rm.f(float, float) #1

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.mul.rm.ftz.f(float, float) #1
...
!7 = !DIFile(filename: "tests/basic_tests/overflow/round_negative.cu", directory: "/home/users/sislam3/SBAC-PAD")
!8 = !{!9}
...
!961 = !{i32 2, i32 0}
!962 = distinct !DISubprogram(name: "testOverflow_RoundNegative", linkageName: "_Z26testOverflow_RoundNegativePf", scope: !7, file: !7, line: 6, type: !963, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !965)
...
!981 = !DILocalVariable(name: "__a", arg: 1, scope: !982, file: !983, line: 197, type: !109)
!982 = distinct !DISubprogram(name: "__fadd_rd", linkageName: "_ZL9__fadd_rdff", scope: !983, file: !983, line: 197, type: !120, scopeLine: 197, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6, retainedNodes: !965)
...
!986 = !DILocalVariable(name: "__b", arg: 2, scope: !982, file: !983, line: 197, type: !109)
...
!999 = !DILocalVariable(name: "__a", arg: 1, scope: !1000, file: !983, line: 303, type: !109)
!1000 = distinct !DISubprogram(name: "__fmul_rd", linkageName: "_ZL9__fmul_rdff", scope: !983, file: !983, line: 303, type: !120, scopeLine: 303, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6, retainedNodes: !965)
!1001 = !DILocation(line: 303, column: 34, scope: !1000, inlinedAt: !1002)
!1002 = distinct !DILocation(line: 23, column: 21, scope: !998)
!1003 = !DILocalVariable(name: "__b", arg: 2, scope: !1000, file: !983, line: 303, type: !109)
