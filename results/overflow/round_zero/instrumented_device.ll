...
source_filename = "tests/basic_tests/overflow/round_zero.cu"
...
if.then:                                          ; preds = %entry
  ...
  %6 = call float @llvm.nvvm.add.rz.f(float %4, float %5), !dbg !990
...
if.then3:                                         ; preds = %if.end
  ...
  %12 = call float @llvm.nvvm.mul.rz.f(float %10, float %11), !dbg !1007
...
if.then8:                                         ; preds = %if.end6
  ...
  %18 = call float @llvm.nvvm.mul.rz.f(float %16, float %17), !dbg !1022
...
72:                                               ; preds = %if.then13, %70
  %73 = call float @llvm.nvvm.fma.rz.f(float %23, float %24, float %25), !dbg !1043
  ...
  %overflow_cond = and i1 %79, %is_maxfinite, !dbg !1044
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.add.rz.ftz.f(float, float) #1

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.add.rz.f(float, float) #1

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.mul.rz.ftz.f(float, float) #1
...
!7 = !DIFile(filename: "tests/basic_tests/overflow/round_zero.cu", directory: "/home/users/sislam3/SBAC-PAD")
!8 = !{!9}
...
!961 = !{i32 2, i32 0}
!962 = distinct !DISubprogram(name: "testOverflow_RoundZero", linkageName: "_Z22testOverflow_RoundZeroPf", scope: !7, file: !7, line: 6, type: !963, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !965)
...
!981 = !DILocalVariable(name: "__a", arg: 1, scope: !982, file: !983, line: 206, type: !109)
!982 = distinct !DISubprogram(name: "__fadd_rz", linkageName: "_ZL9__fadd_rzff", scope: !983, file: !983, line: 206, type: !120, scopeLine: 206, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6, retainedNodes: !965)
...
!986 = !DILocalVariable(name: "__b", arg: 2, scope: !982, file: !983, line: 206, type: !109)
...
!999 = !DILocalVariable(name: "__a", arg: 1, scope: !1000, file: !983, line: 312, type: !109)
!1000 = distinct !DISubprogram(name: "__fmul_rz", linkageName: "_ZL9__fmul_rzff", scope: !983, file: !983, line: 312, type: !120, scopeLine: 312, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6, retainedNodes: !965)
!1001 = !DILocation(line: 312, column: 34, scope: !1000, inlinedAt: !1002)
!1002 = distinct !DILocation(line: 20, column: 21, scope: !998)
!1003 = !DILocalVariable(name: "__b", arg: 2, scope: !1000, file: !983, line: 312, type: !109)
...
!1032 = !DILocalVariable(name: "__a", arg: 1, scope: !1033, file: !983, line: 300, type: !109)
!1033 = distinct !DISubprogram(name: "__fmaf_rz", linkageName: "_ZL9__fmaf_rzfff", scope: !983, file: !983, line: 300, type: !152, scopeLine: 300, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6, retainedNodes: !965)
!1034 = !DILocation(line: 300, column: 34, scope: !1033, inlinedAt: !1035)
!1035 = distinct !DILocation(line: 30, column: 21, scope: !1030)
!1036 = !DILocalVariable(name: "__b", arg: 2, scope: !1033, file: !983, line: 300, type: !109)
!1037 = !DILocation(line: 300, column: 45, scope: !1033, inlinedAt: !1035)
!1038 = !DILocalVariable(name: "__c", arg: 3, scope: !1033, file: !983, line: 300, type: !109)
