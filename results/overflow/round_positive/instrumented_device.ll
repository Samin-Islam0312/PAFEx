...
source_filename = "tests/basic_tests/overflow/round_positive.cu"
...
if.then:                                          ; preds = %entry
  ...
  %6 = call float @llvm.nvvm.add.rp.f(float %4, float %5), !dbg !990
...
if.then3:                                         ; preds = %if.end
  ...
  store float %9, ptr %__a.addr.i25, align 4
  ...
  %10 = load float, ptr %__a.addr.i25, align 4, !dbg !1005
  %11 = load float, ptr %__b.addr.i26, align 4, !dbg !1006
  %12 = call float @llvm.nvvm.mul.rp.f(float %10, float %11), !dbg !1007
...
if.then8:                                         ; preds = %if.end6
  ...
  %16 = load float, ptr %__a.addr.i22, align 4, !dbg !1020
  %17 = load float, ptr %__b.addr.i23, align 4, !dbg !1021
  %18 = call float @llvm.nvvm.mul.rp.f(float %16, float %17), !dbg !1022
...
if.then13:                                        ; preds = %if.end11
  ...
  %fneg14 = fneg contract float %21, !dbg !1031
  %22 = load float, ptr %large, align 4, !dbg !1032
  %fneg15 = fneg contract float %22, !dbg !1033
  ...
  %23 = load float, ptr %__a.addr.i, align 4, !dbg !1037
  %24 = load float, ptr %__b.addr.i, align 4, !dbg !1038
  %25 = call float @llvm.nvvm.add.rp.f(float %23, float %24), !dbg !1039
  %26 = load ptr, ptr %result.addr, align 8, !dbg !1040
  %arrayidx17 = getelementptr inbounds float, ptr %26, i64 3, !dbg !1040
  store float %25, ptr %arrayidx17, align 4, !dbg !1041
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.add.rp.ftz.f(float, float) #1

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.add.rp.f(float, float) #1

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare float @llvm.nvvm.mul.rp.ftz.f(float, float) #1
...
!7 = !DIFile(filename: "tests/basic_tests/overflow/round_positive.cu", directory: "/home/users/sislam3/SBAC-PAD")
!8 = !{!9}
...
!961 = !{i32 2, i32 0}
!962 = distinct !DISubprogram(name: "testOverflow_RoundPositive", linkageName: "_Z26testOverflow_RoundPositivePf", scope: !7, file: !7, line: 6, type: !963, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !965)
...
!976 = distinct !DILexicalBlock(scope: !962, file: !7, line: 16, column: 9)
!977 = !DILocation(line: 16, column: 13, scope: !976)
!978 = !DILocation(line: 18, column: 31, scope: !979)
!979 = distinct !DILexicalBlock(scope: !976, file: !7, line: 16, column: 19)
!980 = !DILocation(line: 18, column: 38, scope: !979)
!981 = !DILocalVariable(name: "__a", arg: 1, scope: !982, file: !983, line: 203, type: !109)
!982 = distinct !DISubprogram(name: "__fadd_ru", linkageName: "_ZL9__fadd_ruff", scope: !983, file: !983, line: 203, type: !120, scopeLine: 203, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6, retainedNodes: !965)
...
!986 = !DILocalVariable(name: "__b", arg: 2, scope: !982, file: !983, line: 203, type: !109)
...
!995 = distinct !DILexicalBlock(scope: !962, file: !7, line: 21, column: 9)
!996 = !DILocation(line: 21, column: 13, scope: !995)
!997 = !DILocation(line: 23, column: 31, scope: !998)
!998 = distinct !DILexicalBlock(scope: !995, file: !7, line: 21, column: 19)
!999 = !DILocalVariable(name: "__a", arg: 1, scope: !1000, file: !983, line: 309, type: !109)
!1000 = distinct !DISubprogram(name: "__fmul_ru", linkageName: "_ZL9__fmul_ruff", scope: !983, file: !983, line: 309, type: !120, scopeLine: 309, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6, retainedNodes: !965)
!1001 = !DILocation(line: 309, column: 34, scope: !1000, inlinedAt: !1002)
!1002 = distinct !DILocation(line: 23, column: 21, scope: !998)
!1003 = !DILocalVariable(name: "__b", arg: 2, scope: !1000, file: !983, line: 309, type: !109)
...
!1012 = distinct !DILexicalBlock(scope: !962, file: !7, line: 26, column: 9)
!1013 = !DILocation(line: 26, column: 13, scope: !1012)
!1014 = !DILocation(line: 28, column: 32, scope: !1015)
!1015 = distinct !DILexicalBlock(scope: !1012, file: !7, line: 26, column: 19)
...
!1027 = distinct !DILexicalBlock(scope: !962, file: !7, line: 31, column: 9)
!1028 = !DILocation(line: 31, column: 13, scope: !1027)
!1029 = !DILocation(line: 33, column: 32, scope: !1030)
!1030 = distinct !DILexicalBlock(scope: !1027, file: !7, line: 31, column: 19)
