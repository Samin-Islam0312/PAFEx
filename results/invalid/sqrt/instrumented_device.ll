; ModuleID = '/home/users/sislam3/SBAC-PAD/results/invalid/sqrt/instrumented_device.bc'
...
entry:
  %__a.addr.i42 = alloca float, align 4
  %__a.addr.i40 = alloca float, align 4
  %__a.addr.i38 = alloca float, align 4
  %__a.addr.i36 = alloca float, align 4
  %__a.addr.i34 = alloca float, align 4
  %__a.addr.i32 = alloca float, align 4
  ...
  %1 = load i32, ptr %idx, align 4, !dbg !973
  %cmp = icmp eq i32 %1, 0, !dbg !975
  br i1 %cmp, label %if.then, label %if.end, !dbg !975

if.then:                                          ; preds = %entry
  store float -1.000000e+00, ptr %__a.addr.i42, align 4
    #dbg_declare(ptr %__a.addr.i42, !976, !DIExpression(), !977)
  %2 = load float, ptr %__a.addr.i42, align 4, !dbg !979
  %3 = bitcast float %2 to i32, !dbg !980
  %4 = bitcast float %2 to i32, !dbg !980
  %5 = and i32 %4, 2139095040, !dbg !980
  %6 = icmp eq i32 %5, 2139095040, !dbg !980
  %7 = and i32 %4, 8388607, !dbg !980
  %8 = icmp ne i32 %7, 0, !dbg !980
  %is_nan = and i1 %6, %8, !dbg !980
  %9 = and i32 %3, 4194304, !dbg !980
  %10 = icmp eq i32 %9, 0, !dbg !980
  %is_snan = and i1 %is_nan, %10, !dbg !980
  %11 = bitcast float %2 to i32, !dbg !980
  %12 = and i32 %11, -2147483648, !dbg !980
  %is_neg = icmp ne i32 %12, 0, !dbg !980
  %13 = or i1 %is_snan, %is_neg, !dbg !980
...
16:                                               ; preds = %if.then, %14
  %17 = call float @llvm.nvvm.sqrt.approx.f(float %2) #3, !dbg !980
  %18 = load ptr, ptr %result.addr, align 8, !dbg !981
  %arrayidx = getelementptr inbounds float, ptr %18, i64 0, !dbg !981
  store float %17, ptr %arrayidx, align 4, !dbg !982
  br label %if.end, !dbg !981

if.end:                                           ; preds = %16, %entry
  %19 = load i32, ptr %idx, align 4, !dbg !983
  %cmp2 = icmp eq i32 %19, 1, !dbg !985
  br i1 %cmp2, label %if.then3, label %if.end6, !dbg !985

if.then3:                                         ; preds = %if.end
  store float -1.000000e+02, ptr %__a.addr.i40, align 4
    #dbg_declare(ptr %__a.addr.i40, !976, !DIExpression(), !986)
  %20 = load float, ptr %__a.addr.i40, align 4, !dbg !988
  %21 = bitcast float %20 to i32, !dbg !989
  %22 = bitcast float %20 to i32, !dbg !989
  %23 = and i32 %22, 2139095040, !dbg !989
  %24 = icmp eq i32 %23, 2139095040, !dbg !989
  %25 = and i32 %22, 8388607, !dbg !989
  %26 = icmp ne i32 %25, 0, !dbg !989
  %is_nan1 = and i1 %24, %26, !dbg !989
  %27 = and i32 %21, 4194304, !dbg !989
  %28 = icmp eq i32 %27, 0, !dbg !989
  %is_snan2 = and i1 %is_nan1, %28, !dbg !989
  %29 = bitcast float %20 to i32, !dbg !989
  %30 = and i32 %29, -2147483648, !dbg !989
  %is_neg3 = icmp ne i32 %30, 0, !dbg !989
  %31 = or i1 %is_snan2, %is_neg3, !dbg !989
...
34:                                               ; preds = %if.then3, %32
  %35 = call float @llvm.nvvm.sqrt.approx.f(float %20) #3, !dbg !989
  %36 = load ptr, ptr %result.addr, align 8, !dbg !990
  %arrayidx5 = getelementptr inbounds float, ptr %36, i64 1, !dbg !990
  store float %35, ptr %arrayidx5, align 4, !dbg !991
  br label %if.end6, !dbg !990

if.end6:                                          ; preds = %34, %if.end
  %37 = load i32, ptr %idx, align 4, !dbg !992
  %cmp7 = icmp eq i32 %37, 2, !dbg !994
  br i1 %cmp7, label %if.then8, label %if.end11, !dbg !994

if.then8:                                         ; preds = %if.end6
  store float -5.000000e-01, ptr %__a.addr.i38, align 4
    #dbg_declare(ptr %__a.addr.i38, !976, !DIExpression(), !995)
  %38 = load float, ptr %__a.addr.i38, align 4, !dbg !997
  %39 = bitcast float %38 to i32, !dbg !998
  %40 = bitcast float %38 to i32, !dbg !998
  %41 = and i32 %40, 2139095040, !dbg !998
  %42 = icmp eq i32 %41, 2139095040, !dbg !998
  %43 = and i32 %40, 8388607, !dbg !998
  %44 = icmp ne i32 %43, 0, !dbg !998
  %is_nan4 = and i1 %42, %44, !dbg !998
  %45 = and i32 %39, 4194304, !dbg !998
  %46 = icmp eq i32 %45, 0, !dbg !998
  %is_snan5 = and i1 %is_nan4, %46, !dbg !998
  %47 = bitcast float %38 to i32, !dbg !998
  %48 = and i32 %47, -2147483648, !dbg !998
  %is_neg6 = icmp ne i32 %48, 0, !dbg !998
  %49 = or i1 %is_snan5, %is_neg6, !dbg !998
...
52:                                               ; preds = %if.then8, %50
  %53 = call float @llvm.nvvm.sqrt.approx.f(float %38) #3, !dbg !998
  %54 = load ptr, ptr %result.addr, align 8, !dbg !999
  %arrayidx10 = getelementptr inbounds float, ptr %54, i64 2, !dbg !999
  store float %53, ptr %arrayidx10, align 4, !dbg !1000
  br label %if.end11, !dbg !999

if.end11:                                         ; preds = %52, %if.end6
  %55 = load i32, ptr %idx, align 4, !dbg !1001
  %cmp12 = icmp eq i32 %55, 3, !dbg !1003
  br i1 %cmp12, label %if.then13, label %if.end16, !dbg !1003

if.then13:                                        ; preds = %if.end11
  store float 0.000000e+00, ptr %__a.addr.i36, align 4
    #dbg_declare(ptr %__a.addr.i36, !976, !DIExpression(), !1004)
  %56 = load float, ptr %__a.addr.i36, align 4, !dbg !1006
  %57 = bitcast float %56 to i32, !dbg !1007
  %58 = bitcast float %56 to i32, !dbg !1007
  %59 = and i32 %58, 2139095040, !dbg !1007
  %60 = icmp eq i32 %59, 2139095040, !dbg !1007
  %61 = and i32 %58, 8388607, !dbg !1007
  %62 = icmp ne i32 %61, 0, !dbg !1007
  %is_nan7 = and i1 %60, %62, !dbg !1007
  %63 = and i32 %57, 4194304, !dbg !1007
  %64 = icmp eq i32 %63, 0, !dbg !1007
  %is_snan8 = and i1 %is_nan7, %64, !dbg !1007
  %65 = bitcast float %56 to i32, !dbg !1007
  %66 = and i32 %65, -2147483648, !dbg !1007
  %is_neg9 = icmp ne i32 %66, 0, !dbg !1007
  %67 = or i1 %is_snan8, %is_neg9, !dbg !1007
...
70:                                               ; preds = %if.then13, %68
  %71 = call float @llvm.nvvm.sqrt.approx.f(float %56) #3, !dbg !1007
  %72 = load ptr, ptr %result.addr, align 8, !dbg !1008
  %arrayidx15 = getelementptr inbounds float, ptr %72, i64 3, !dbg !1008
  store float %71, ptr %arrayidx15, align 4, !dbg !1009
  br label %if.end16, !dbg !1008

if.end16:                                         ; preds = %70, %if.end11
  %73 = load i32, ptr %idx, align 4, !dbg !1010
  %cmp17 = icmp eq i32 %73, 4, !dbg !1012
  br i1 %cmp17, label %if.then18, label %if.end21, !dbg !1012

if.then18:                                        ; preds = %if.end16
  store float -0.000000e+00, ptr %__a.addr.i34, align 4
    #dbg_declare(ptr %__a.addr.i34, !976, !DIExpression(), !1013)
  %74 = load float, ptr %__a.addr.i34, align 4, !dbg !1015
  %75 = bitcast float %74 to i32, !dbg !1016
  %76 = bitcast float %74 to i32, !dbg !1016
  %77 = and i32 %76, 2139095040, !dbg !1016
  %78 = icmp eq i32 %77, 2139095040, !dbg !1016
  %79 = and i32 %76, 8388607, !dbg !1016
  %80 = icmp ne i32 %79, 0, !dbg !1016
  %is_nan10 = and i1 %78, %80, !dbg !1016
  %81 = and i32 %75, 4194304, !dbg !1016
  %82 = icmp eq i32 %81, 0, !dbg !1016
  %is_snan11 = and i1 %is_nan10, %82, !dbg !1016
  %83 = bitcast float %74 to i32, !dbg !1016
  %84 = and i32 %83, -2147483648, !dbg !1016
  %is_neg12 = icmp ne i32 %84, 0, !dbg !1016
  %85 = or i1 %is_snan11, %is_neg12, !dbg !1016
...
88:                                               ; preds = %if.then18, %86
  %89 = call float @llvm.nvvm.sqrt.approx.f(float %74) #3, !dbg !1016
  %90 = load ptr, ptr %result.addr, align 8, !dbg !1017
  %arrayidx20 = getelementptr inbounds float, ptr %90, i64 4, !dbg !1017
  store float %89, ptr %arrayidx20, align 4, !dbg !1018
  br label %if.end21, !dbg !1017

if.end21:                                         ; preds = %88, %if.end16
  %91 = load i32, ptr %idx, align 4, !dbg !1019
  %cmp22 = icmp eq i32 %91, 5, !dbg !1021
  br i1 %cmp22, label %if.then23, label %if.end26, !dbg !1021

if.then23:                                        ; preds = %if.end21
  store float 4.000000e+00, ptr %__a.addr.i32, align 4
    #dbg_declare(ptr %__a.addr.i32, !976, !DIExpression(), !1022)
  %92 = load float, ptr %__a.addr.i32, align 4, !dbg !1024
  %93 = bitcast float %92 to i32, !dbg !1025
  %94 = bitcast float %92 to i32, !dbg !1025
  %95 = and i32 %94, 2139095040, !dbg !1025
  %96 = icmp eq i32 %95, 2139095040, !dbg !1025
  %97 = and i32 %94, 8388607, !dbg !1025
  %98 = icmp ne i32 %97, 0, !dbg !1025
  %is_nan13 = and i1 %96, %98, !dbg !1025
  %99 = and i32 %93, 4194304, !dbg !1025
  %100 = icmp eq i32 %99, 0, !dbg !1025
  %is_snan14 = and i1 %is_nan13, %100, !dbg !1025
  %101 = bitcast float %92 to i32, !dbg !1025
  %102 = and i32 %101, -2147483648, !dbg !1025
  %is_neg15 = icmp ne i32 %102, 0, !dbg !1025
  %103 = or i1 %is_snan14, %is_neg15, !dbg !1025
...
106:                                              ; preds = %if.then23, %104
  %107 = call float @llvm.nvvm.sqrt.approx.f(float %92) #3, !dbg !1025
  %108 = load ptr, ptr %result.addr, align 8, !dbg !1026
  %arrayidx25 = getelementptr inbounds float, ptr %108, i64 5, !dbg !1026
  store float %107, ptr %arrayidx25, align 4, !dbg !1027
  br label %if.end26, !dbg !1026

if.end26:                                         ; preds = %106, %if.end21
    #dbg_declare(ptr %neg_inf, !1028, !DIExpression(), !1029)
  store float 0xFFF0000000000000, ptr %neg_inf, align 4, !dbg !1029
  %109 = load i32, ptr %idx, align 4, !dbg !1030
  %cmp27 = icmp eq i32 %109, 6, !dbg !1032
  br i1 %cmp27, label %if.then28, label %if.end31, !dbg !1032

if.then28:                                        ; preds = %if.end26
  %110 = load float, ptr %neg_inf, align 4, !dbg !1033
  store float %110, ptr %__a.addr.i, align 4
    #dbg_declare(ptr %__a.addr.i, !976, !DIExpression(), !1034)
  %111 = load float, ptr %__a.addr.i, align 4, !dbg !1036
  %112 = bitcast float %111 to i32, !dbg !1037
  %113 = bitcast float %111 to i32, !dbg !1037
  %114 = and i32 %113, 2139095040, !dbg !1037
  %115 = icmp eq i32 %114, 2139095040, !dbg !1037
  %116 = and i32 %113, 8388607, !dbg !1037
  %117 = icmp ne i32 %116, 0, !dbg !1037
  %is_nan16 = and i1 %115, %117, !dbg !1037
  %118 = and i32 %112, 4194304, !dbg !1037
  %119 = icmp eq i32 %118, 0, !dbg !1037
  %is_snan17 = and i1 %is_nan16, %119, !dbg !1037
  %120 = bitcast float %111 to i32, !dbg !1037
  %121 = and i32 %120, -2147483648, !dbg !1037
  %is_neg18 = icmp ne i32 %121, 0, !dbg !1037
  %122 = or i1 %is_snan17, %is_neg18, !dbg !1037
...
125:                                              ; preds = %if.then28, %123
  %126 = call float @llvm.nvvm.sqrt.approx.f(float %111) #3, !dbg !1037
  %127 = load ptr, ptr %result.addr, align 8, !dbg !1038
  %arrayidx30 = getelementptr inbounds float, ptr %127, i64 6, !dbg !1038
  store float %126, ptr %arrayidx30, align 4, !dbg !1039
  br label %if.end31, !dbg !1038

if.end31:                                         ; preds = %125, %if.end26
  ret void, !dbg !1040
}
...
!1 = !DIFile(filename: "tests/basic_tests/invalid/sqrt.cu", directory: "/home/users/sislam3/SBAC-PAD")
!2 = !{!3}
...
!929 = distinct !DISubprogram(name: "sqrtf", linkageName: "_ZL5sqrtff", scope: !828, file: !828, line: 318, type: !101, scopeLine: 318, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !930)
!930 = !{}
...
!963 = distinct !DISubprogram(name: "testInvalidSqrt", linkageName: "_Z15testInvalidSqrtPf", scope: !1, file: !1, line: 5, type: !964, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !930)
!964 = !DISubroutineType(types: !965)
!965 = !{null, !234}
!966 = !DILocalVariable(name: "result", arg: 1, scope: !963, file: !1, line: 5, type: !234)
!967 = !DILocation(line: 5, column: 40, scope: !963)
...
!973 = !DILocation(line: 9, column: 9, scope: !974)
!974 = distinct !DILexicalBlock(scope: !963, file: !1, line: 9, column: 9)
!975 = !DILocation(line: 9, column: 13, scope: !974)
!976 = !DILocalVariable(name: "__a", arg: 1, scope: !929, file: !828, line: 318, type: !103)
!977 = !DILocation(line: 318, column: 30, scope: !929, inlinedAt: !978)
!978 = distinct !DILocation(line: 9, column: 31, scope: !974)
!979 = !DILocation(line: 318, column: 55, scope: !929, inlinedAt: !978)
!980 = !DILocation(line: 318, column: 44, scope: !929, inlinedAt: !978)
!981 = !DILocation(line: 9, column: 19, scope: !974)
!982 = !DILocation(line: 9, column: 29, scope: !974)
!983 = !DILocation(line: 10, column: 9, scope: !984)
!984 = distinct !DILexicalBlock(scope: !963, file: !1, line: 10, column: 9)
!985 = !DILocation(line: 10, column: 13, scope: !984)
!986 = !DILocation(line: 318, column: 30, scope: !929, inlinedAt: !987)
!987 = distinct !DILocation(line: 10, column: 31, scope: !984)
!988 = !DILocation(line: 318, column: 55, scope: !929, inlinedAt: !987)
!989 = !DILocation(line: 318, column: 44, scope: !929, inlinedAt: !987)
!990 = !DILocation(line: 10, column: 19, scope: !984)
!991 = !DILocation(line: 10, column: 29, scope: !984)
!992 = !DILocation(line: 11, column: 9, scope: !993)
!993 = distinct !DILexicalBlock(scope: !963, file: !1, line: 11, column: 9)
!994 = !DILocation(line: 11, column: 13, scope: !993)
!995 = !DILocation(line: 318, column: 30, scope: !929, inlinedAt: !996)
!996 = distinct !DILocation(line: 11, column: 31, scope: !993)
!997 = !DILocation(line: 318, column: 55, scope: !929, inlinedAt: !996)
!998 = !DILocation(line: 318, column: 44, scope: !929, inlinedAt: !996)
!999 = !DILocation(line: 11, column: 19, scope: !993)
!1000 = !DILocation(line: 11, column: 29, scope: !993)
!1001 = !DILocation(line: 14, column: 9, scope: !1002)
!1002 = distinct !DILexicalBlock(scope: !963, file: !1, line: 14, column: 9)
!1003 = !DILocation(line: 14, column: 13, scope: !1002)
!1004 = !DILocation(line: 318, column: 30, scope: !929, inlinedAt: !1005)
!1005 = distinct !DILocation(line: 14, column: 31, scope: !1002)
!1006 = !DILocation(line: 318, column: 55, scope: !929, inlinedAt: !1005)
!1007 = !DILocation(line: 318, column: 44, scope: !929, inlinedAt: !1005)
!1008 = !DILocation(line: 14, column: 19, scope: !1002)
!1009 = !DILocation(line: 14, column: 29, scope: !1002)
!1010 = !DILocation(line: 15, column: 9, scope: !1011)
!1011 = distinct !DILexicalBlock(scope: !963, file: !1, line: 15, column: 9)
!1012 = !DILocation(line: 15, column: 13, scope: !1011)
!1013 = !DILocation(line: 318, column: 30, scope: !929, inlinedAt: !1014)
!1014 = distinct !DILocation(line: 15, column: 31, scope: !1011)
!1015 = !DILocation(line: 318, column: 55, scope: !929, inlinedAt: !1014)
!1016 = !DILocation(line: 318, column: 44, scope: !929, inlinedAt: !1014)
!1017 = !DILocation(line: 15, column: 19, scope: !1011)
!1018 = !DILocation(line: 15, column: 29, scope: !1011)
!1019 = !DILocation(line: 16, column: 9, scope: !1020)
!1020 = distinct !DILexicalBlock(scope: !963, file: !1, line: 16, column: 9)
!1021 = !DILocation(line: 16, column: 13, scope: !1020)
!1022 = !DILocation(line: 318, column: 30, scope: !929, inlinedAt: !1023)
!1023 = distinct !DILocation(line: 16, column: 31, scope: !1020)
!1024 = !DILocation(line: 318, column: 55, scope: !929, inlinedAt: !1023)
!1025 = !DILocation(line: 318, column: 44, scope: !929, inlinedAt: !1023)
!1026 = !DILocation(line: 16, column: 19, scope: !1020)
!1027 = !DILocation(line: 16, column: 29, scope: !1020)
!1028 = !DILocalVariable(name: "neg_inf", scope: !963, file: !1, line: 19, type: !103)
!1029 = !DILocation(line: 19, column: 11, scope: !963)
!1030 = !DILocation(line: 20, column: 9, scope: !1031)
!1031 = distinct !DILexicalBlock(scope: !963, file: !1, line: 20, column: 9)
!1032 = !DILocation(line: 20, column: 13, scope: !1031)
!1033 = !DILocation(line: 20, column: 37, scope: !1031)
!1034 = !DILocation(line: 318, column: 30, scope: !929, inlinedAt: !1035)
!1035 = distinct !DILocation(line: 20, column: 31, scope: !1031)
!1036 = !DILocation(line: 318, column: 55, scope: !929, inlinedAt: !1035)
!1037 = !DILocation(line: 318, column: 44, scope: !929, inlinedAt: !1035)
!1038 = !DILocation(line: 20, column: 19, scope: !1031)
!1039 = !DILocation(line: 20, column: 29, scope: !1031)
!1040 = !DILocation(line: 21, column: 1, scope: !963)
